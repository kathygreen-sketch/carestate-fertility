...
(function () {
  ...
  var STRINGS = {
    ...
    en: {
      ...
      // Index / Landing page
      'index.badge':           'The 9 PM Standard',
      'index.h1_line1':        'The Standard in',
      'index.h1_line2':        'Fertility Navigation.',
      'index.subhead1':        'Precision for your most personal journey.',
      'index.subhead2':        'Simply taken care of.',
      'index.body':            'The only clinical companion built for the exact moment you need it most — 9 PM, injection time, absolute clarity.',
      'index.cta_patient':     'Experience the Sanctuary',
      'index.cta_clinical':    'Clinical Partner View',
      'index.stat1_label':     'Priority Support',
      'index.stat2_label':     'Languages',
      'index.stat3_label':     'Loop Closer',
      'index.stat4_label':     'Architecture Ready',
      'index.qr_title':        'Scan to Access',
      'index.qr_sub':          'Open CareState on your phone — iPhone & Android',
      'index.roles_label':     'Choose your experience',
      'index.roles_h2':        'Who are you today?',
      'index.patient_badge':   'Patient',
      'index.patient_h3':      "I'm managing my IVF cycle",
      'index.patient_desc':    'Access your Cycle Pulse, medication schedule, 9 PM SOS Bridge, and Protocol Decoder. Your clinical companion — always on.',
      'index.patient_cta':     'Open Patient View',
      'index.clinical_badge':  'Clinical',
      'index.clinical_h3':     "I'm a nurse or coordinator",
      'index.clinical_desc':   'Monitor your patient panel, authorize medications, send Tactical Intervention signals, and receive live loop-close notifications.',
      'index.clinical_cta':    'Open Command Center',
      'index.how_label':       'The Cycle',
      'index.how_h2':          'How CareState works',
      'index.pill_capture':    'Clinic Capture',
      'index.pill_decoder':    'Protocol Decoder',
      'index.pill_today':      "Today's Care",
      'index.step1_h':         'Clinic Capture',
      'index.step1_p':         "Scan your protocol handout or record your doctor's voice. Every instruction lands in your encrypted Protocol Vault — no note-taking, total clarity.",
      'index.step2_h':         '9 PM Cycle Pulse',
      'index.step2_p':         'At 9 PM a Peace Pulse check-in appears. Your verified injection guide is ready. If any uncertainty arises — air bubble, needle issue, missed dose — the SOS Bridge delivers 3-tap resolution.',
      'index.step3_h':         'Loop Closed',
      'index.step3_p':         "The moment a patient confirms their dose, the nurse's dashboard flips from Pending to Verified in real-time. Zero phone tag. Zero missed doses.",
      'index.footer_brand':    'The Art of Being Taken Care Of.',
      'index.footer_patient':  'Patient Dashboard',
      'index.footer_capture':  'Clinic Capture',
      'index.footer_decoder':  'Protocol Decoder',
      'index.footer_partner':  'Partner Command',
      'index.nav_patient':     'Patient View',
      'index.nav_clinical':    'Clinical Login',
      'index.demo_mode':       'Demo Mode',
    },
    ...
    zh: {
      ...
      // Index / Landing page
      'index.badge':           '晚9点标准',
      'index.h1_line1':        '生育导航的',
      'index.h1_line2':        '行业标准。',
      'index.subhead1':        '为您最私密的旅程提供精准支持。',
      'index.subhead2':        '简单，放心，有人照顾。',
      'index.body':            '唯一专为您最需要的那一刻而打造的临床伴侣 — 晚9点，注射时间，绝对清晰。',
      'index.cta_patient':     '体验安心服务',
      'index.cta_clinical':    '临床合作伙伴视图',
      'index.stat1_label':     '优先支持',
      'index.stat2_label':     '语言',
      'index.stat3_label':     '闭环追踪',
      'index.stat4_label':     '架构就绪',
      'index.qr_title':        '扫码访问',
      'index.qr_sub':          '在手机上打开CareState — iPhone和Android均支持',
      'index.roles_label':     '选择您的体验',
      'index.roles_h2':        '今天，您是哪位？',
      'index.patient_badge':   '患者',
      'index.patient_h3':      '我正在进行IVF周期',
      'index.patient_desc':    '访问您的周期脉搏、用药计划、晚9点SOS紧急通道和方案解码器。您的临床伴侣 — 全天候在线。',
      'index.patient_cta':     '打开患者视图',
      'index.clinical_badge':  '临床',
      'index.clinical_h3':     '我是护士或协调员',
      'index.clinical_desc':   '监控您的患者面板、授权用药、发送精准干预信号，并接收实时闭环通知。',
      'index.clinical_cta':    '打开指挥中心',
      'index.how_label':       '周期流程',
      'index.how_h2':          'CareState如何运作',
      'index.pill_capture':    '诊所采集',
      'index.pill_decoder':    '方案解码器',
      'index.pill_today':      '今日护理',
      'index.step1_h':         '诊所采集',
      'index.step1_p':         '扫描方案手册或录制医生的声音。每条指令都安全存储在您的加密方案库中 — 无需记笔记，完全清晰。',
      'index.step2_h':         '晚9点周期脉搏',
      'index.step2_p':         '晚9点会出现平和脉搏检查。您的验证注射指南已就绪。如有任何不确定 — 气泡、针头问题、漏剂 — SOS紧急通道提供三步解决。',
      'index.step3_h':         '闭环完成',
      'index.step3_p':         '患者确认用药的那一刻，护士的面板就会从"待确认"变为"已确认"。零电话追踪，零漏剂。',
      'index.footer_brand':    '被悉心照料的艺术。',
      'index.footer_patient':  '患者面板',
      'index.footer_capture':  '诊所采集',
      'index.footer_decoder':  '方案解码器',
      'index.footer_partner':  '伙伴指挥',
      'index.nav_patient':     '患者视图',
      'index.nav_clinical':    '临床登录',
      'index.demo_mode':       '演示模式',
    },
    ...
    es: {
      ...
      // Index / Landing page
      'index.badge':           'El Estándar de las 9 PM',
      'index.h1_line1':        'El Estándar en',
      'index.h1_line2':        'Navegación de Fertilidad.',
      'index.subhead1':        'Precisión para tu viaje más personal.',
      'index.subhead2':        'Simplemente cuidada.',
      'index.body':            'El único acompañante clínico diseñado para el momento exacto en que más lo necesitas — 9 PM, hora de inyección, claridad absoluta.',
      'index.cta_patient':     'Experimenta el Santuario',
      'index.cta_clinical':    'Vista de Socio Clínico',
      'index.stat1_label':     'Soporte Prioritario',
      'index.stat2_label':     'Idiomas',
      'index.stat3_label':     'Loop Closer',
      'index.stat4_label':     'Arquitectura Lista',
      'index.qr_title':        'Escanea para Acceder',
      'index.qr_sub':          'Abre CareState en tu teléfono — iPhone y Android',
      'index.roles_label':     'Elige tu experiencia',
      'index.roles_h2':        '¿Quién eres hoy?',
      'index.patient_badge':   'Paciente',
      'index.patient_h3':      'Estoy manejando mi ciclo FIV',
      'index.patient_desc':    'Accede a tu Cycle Pulse, horario de medicamentos, Puente SOS de las 9 PM y Protocol Decoder. Tu acompañante clínico — siempre activo.',
      'index.patient_cta':     'Abrir Vista de Paciente',
      'index.clinical_badge':  'Clínico',
      'index.clinical_h3':     'Soy enfermera o coordinadora',
      'index.clinical_desc':   'Monitorea tu panel de pacientes, autoriza medicamentos, envía señales de Intervención Táctica y recibe notificaciones en vivo.',
      'index.clinical_cta':    'Abrir Centro de Comando',
      'index.how_label':       'El Ciclo',
      'index.how_h2':          'Cómo funciona CareState',
      'index.pill_capture':    'Captura Clínica',
      'index.pill_decoder':    'Decodificador de Protocolo',
      'index.pill_today':      'Cuidado de Hoy',
      'index.step1_h':         'Captura Clínica',
      'index.step1_p':         "Escanea tu protocolo o graba la voz de tu médico. Cada instrucción llega a tu Protocol Vault cifrado — sin tomar notas, total claridad.",
      'index.step2_h':         'Cycle Pulse de las 9 PM',
      'index.step2_p':         'A las 9 PM aparece un check-in de Peace Pulse. Tu guía de inyección verificada está lista. Si surge alguna duda — burbuja, problema con la aguja, dosis perdida — el SOS Bridge ofrece resolución en 3 toques.',
      'index.step3_h':         'Ciclo Cerrado',
      'index.step3_p':         "En el momento en que el paciente confirma su dosis, el panel de la enfermera pasa de Pendiente a Verificado en tiempo real. Cero llamadas. Cero dosis perdidas.",
      'index.footer_brand':    'El Arte de Ser Cuidada.',
      'index.footer_patient':  'Panel de Paciente',
      'index.footer_capture':  'Captura Clínica',
      'index.footer_decoder':  'Decodificador de Protocolo',
      'index.footer_partner':  'Comando de Socio',
      'index.nav_patient':     'Vista de Paciente',
      'index.nav_clinical':    'Inicio Clínico',
      'index.demo_mode':       'Modo Demo',
    },
