...
(function () {
  ...
  var STRINGS = {
    ...
    en: {
      ...
      // Day 5 Wait (Luminous) view
      'dash.luminous.label':       'Lab & Fertilization',
      'dash.luminous.h1':          'Day 3 of The Wait.',
      'dash.luminous.sub':         'Your embryos are with the lab. There is nothing to track today. Your only job is to rest.',
      'dash.luminous.sanctuary':   'Sanctuary Mode Active',
      'dash.luminous.no_injections': 'No injections today.',
      'dash.luminous.lab_msg':     'The lab is working. Your protocol is running. Everything is proceeding as expected.',
      'dash.luminous.lab_status':  'Lab Status',
      'dash.luminous.in_progress': 'In Progress',
      'dash.luminous.guided_pause':'Guided Pause',
      'dash.luminous.quote':       "“This is the part of the cycle that asks you to trust the process. You’ve done everything you could.”",
      'dash.luminous.breathe':     'Try a 2-Minute Breathing Exercise',

      // Retrieval view
      'dash.retrieval.badge':           'Retrieval Day Active',
      'dash.retrieval.h1':              'Today is Retrieval Day.',
      'dash.retrieval.sub':             'Your team is ready. Your companion view is live. You just need to show up.',
      'dash.retrieval.checklist':       'Pre-Op Checklist',
      'dash.retrieval.companion_ready': 'Companion View is Ready',
      'dash.retrieval.companion_sub':   'Read-only logistics shared · Expires midnight',
      'dash.retrieval.companion_cta':   'Open Companion View →',
      'dash.retrieval.arrival':         'Arrival Information',
      'dash.retrieval.arrive_time':     'Arrive 7:45 AM · Check-in 8:30 AM',
      'dash.retrieval.location':        'Riverside Fertility Center, Suite 400',
      'dash.retrieval.npo':             'NPO after midnight — no food or water',
      ...
      'sos.sub':      "What's happening right now?",
      'sos.cta':      'Connect with Clinical Triage',
      'sos.hours':    'Available 7 AM – 11 PM, 7 days',
      'sos.fab':      'SOS Bridge',
      'sos.issue.air.title':    'Air bubble in syringe',
      'sos.issue.air.desc':     'I can see air in the barrel before injecting.',
      'sos.issue.needle.title': 'Needle or equipment issue',
      'sos.issue.needle.desc':  'Bent needle, pen failure, or equipment problem.',
      'sos.issue.missed.title': 'Missed or late dose',
      'sos.issue.missed.desc':  "I didn't take my injection at the scheduled time.",
      'sos.issue.unsure.title': "I'm not sure what's wrong",
      'sos.issue.unsure.desc':  'Something feels off and I need guidance.',
    ...
    zh: {
      ...
      'dash.luminous.label':       '实验室与受精',
      'dash.luminous.h1':          '等待的第3天。',
      'dash.luminous.sub':         '您的胚胎正由实验室处理。今天无需追踪任何信息。您唯一的任务就是休息。',
      'dash.luminous.sanctuary':   '圣所模式已激活',
      'dash.luminous.no_injections': '今天无需注射。',
      'dash.luminous.lab_msg':     '实验室正在工作。您的方案正在进行。一切均按预期推进。',
      'dash.luminous.lab_status':  '实验室状态',
      'dash.luminous.in_progress': '进行中',
      'dash.luminous.guided_pause':'引导暂停',
      'dash.luminous.quote':       '"这是周期中需要您信任过程的部分。您已经竭尽所能。"',
      'dash.luminous.breathe':     '尝试2分钟呼吸练习',

      'dash.retrieval.badge':           '取卵日已激活',
      'dash.retrieval.h1':              '今天是取卵日。',
      'dash.retrieval.sub':             '您的团队已准备就绪。陪伴视图已上线。您只需出现。',
      'dash.retrieval.checklist':       '术前清单',
      'dash.retrieval.companion_ready': '陪伴视图已就绪',
      'dash.retrieval.companion_sub':   '只读物流信息已共享 · 午夜失效',
      'dash.retrieval.companion_cta':   '打开陪伴视图 →',
      'dash.retrieval.arrival':         '到达信息',
      'dash.retrieval.arrive_time':     '到达时间：上午7:45 · 报到：上午8:30',
      'dash.retrieval.location':        'Riverside生育中心，400套间',
      'dash.retrieval.npo':             '午夜后禁食禁水',
      ...
      'sos.fab':    'SOS紧急',
      'sos.issue.air.title':    '注射器中有气泡',
      'sos.issue.air.desc':     '注射前我看到注射器中有空气。',
      'sos.issue.needle.title': '针头或器械问题',
      'sos.issue.needle.desc':  '针头弯折、注射笔故障或器械问题。',
      'sos.issue.missed.title': '漏打或延迟打针',
      'sos.issue.missed.desc':  '我没有在预定时间注射。',
      'sos.issue.unsure.title': '我不确定哪里出了问题',
      'sos.issue.unsure.desc':  '感觉有些不对劲，我需要指引。',
    ...
    es: {
      ...
      'dash.luminous.label':       'Laboratorio y Fertilización',
      'dash.luminous.h1':          'Día 3 de La Espera.',
      'dash.luminous.sub':         'Tus embriones están con el laboratorio. No hay nada que seguir hoy. Tu único trabajo es descansar.',
      'dash.luminous.sanctuary':   'Modo Santuario Activo',
      'dash.luminous.no_injections': 'Sin inyecciones hoy.',
      'dash.luminous.lab_msg':     'El laboratorio está trabajando. Tu protocolo está en marcha. Todo está progresando como se esperaba.',
      'dash.luminous.lab_status':  'Estado del Lab',
      'dash.luminous.in_progress': 'En Progreso',
      'dash.luminous.guided_pause':'Pausa Guiada',
      'dash.luminous.quote':       '"Esta es la parte del ciclo que te pide confiar en el proceso. Has hecho todo lo que podías."',
      'dash.luminous.breathe':     'Prueba un Ejercicio de Respiración de 2 Minutos',

      'dash.retrieval.badge':           'Día de Extracción Activo',
      'dash.retrieval.h1':              'Hoy es el Día de Extracción.',
      'dash.retrieval.sub':             'Tu equipo está listo. Tu vista de compañía está activa. Solo necesitas presentarte.',
      'dash.retrieval.checklist':       'Lista Pre-Operatoria',
      'dash.retrieval.companion_ready': 'Vista de Compañía Lista',
      'dash.retrieval.companion_sub':   'Logística de solo lectura compartida · Expira a medianoche',
      'dash.retrieval.companion_cta':   'Abrir Vista de Compañía →',
      'dash.retrieval.arrival':         'Información de Llegada',
      'dash.retrieval.arrive_time':     'Llegar 7:45 AM · Check-in 8:30 AM',
      'dash.retrieval.location':        'Riverside Fertility Center, Suite 400',
      'dash.retrieval.npo':             'Ayuno después de medianoche — sin comida ni agua',
      ...
      'sos.sub':    '¿Qué está pasando ahora mismo?',
      'sos.cta':    'Conectar con Triaje Clínico',
      'sos.hours':  'Disponible 7 AM – 11 PM, 7 días',
      'sos.fab':    'SOS Puente',
      'sos.issue.air.title':    'Burbuja de aire en la jeringa',
      'sos.issue.air.desc':     'Puedo ver aire en el barril antes de inyectar.',
      'sos.issue.needle.title': 'Problema con la aguja o el equipo',
      'sos.issue.needle.desc':  'Aguja doblada, falla del pen o problema de equipo.',
      'sos.issue.missed.title': 'Dosis perdida o tardía',
      'sos.issue.missed.desc':  'No tomé mi inyección a la hora programada.',
      'sos.issue.unsure.title': 'No estoy segura/o de qué está mal',
      'sos.issue.unsure.desc':  'Algo no se siente bien y necesito orientación.',
