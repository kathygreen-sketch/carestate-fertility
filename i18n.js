...
(function () {
  ...
  var STRINGS = {
    ...
    yue: {
      ...
      'dash.protocol_imported':    '已透過掃描匯入方案',
      'dash.captured_from':        '從臨床手冊中獲取',
      'dash.night_mode_title':     '夜間模式 · 注射時間窗',
      'dash.night_mode_msg':       '晚9點SOS緊急支援已啟動 — 協助只需一按。',
      'dash.med_inventory':        '藥品庫存已確認',
      'dash.med_inventory_sub':    '3日供應已確認 · 18小時後下次審計',
      'dash.upcoming':             '今日即將到來',
      'dash.protocol_complete':    '今晚嘅方案已完成。',
      'dash.protocol_complete_sub':'所有劑量已確認並與診所同步。',
      'dash.logistics_verified':   '物流已確認',
      'dash.verification_pending': '待驗證',
      'dash.next_action':          '下一步 · 現在',
      'dash.what_is':              '咩係',
      'dash.mark_complete':        '標記劑量完成',
      'dash.loop_closed':          '循環已關閉 ✓',
      'dash.syncing':              '同步中…',
      'dash.all_clear':            '一切正常',
      'dash.pending_sync':         '待同步',
      'dash.bridge_rx_active':     '等待同步 · Bridge Rx啟動',
      'dash.delivered_verified':   '已送達並確認 · 下午6:30',
      'dash.no_more_actions':      '今日冇更多操作。',
      'dash.specialty_pharmacy':   '特種藥房',
      'dash.clinic_dr':            '診所 · 陳醫生',
      'dash.protocol_confirmed':   '方案已確認 · 晚7:15',
      'dash.verified_by':          '由…驗證',

      'sheet.confirm_dose':        '確認劑量',
      'sheet.injection_site':      '注射部位',
      'sheet.right_abdomen':       '右腹部',
      'sheet.left_abdomen':        '左腹部',
      'sheet.confirm_complete':    '確認劑量完成',
      'sheet.sync_note':           '記錄時間、部位，並與診所同步。',

      'sos.label':  '晚9點SOS緊急通道',
      'sos.title':  '您並不孤單。',
      'sos.cta':    '聯絡臨床分診',
      'sos.hours':  '每日早7時至晚11時提供服務',
      'sos.fab':    'SOS緊急',

      'capture.safe_room_ready':   '安全室已就緒',
      'capture.label':             '診所資訊採集',
      'capture.headline':          '記錄醫生剛講嘅嘢。',
      'capture.subhead':           '消除指令失憶症。所有內容直接存入安全室。',
      'capture.scan_handout':      '掃描手冊',
      'capture.scan_desc':         '對準任何打印嘅日程或手冊。我們即時提取藥物、劑量和時間。',
      'capture.voice_title':       '錄製醫生回顧',
      'capture.voice_desc':        '當醫生講嘢時點擊錄製。臨床AI提取您嘅下一最佳步驟和任何日程更新。',
      'capture.recent':            '最近採集',
      'capture.no_captures':       '暫無採集記錄。請使用上方掃描或語音功能。',
      'capture.rescan':            '重新掃描',
      'capture.precision_review':  '精準審查',
      'capture.review_title':      '審查提取嘅數據',
      'capture.review_desc':       '儲存到安全室前核驗每條指令。點擊任何卡片進行編輯。',
      'capture.add_manual':        '手動添加指令',
      'capture.slide_to_save':     '滑動儲存到安全室',
      'capture.encrypt_note':      'AES-256加密 · Loop Closer將聯絡您嘅藥房',
      'capture.record_title':      '錄製醫生嘅指示',
      'capture.record_sub':        '點擊麥克風自由發言。臨床AI將提取您嘅下一步驟。',
      'capture.record_recap':      '錄製回顧',
      'capture.ai_summary':        'AI摘要',
      'capture.ai_processing':     '臨床AI正在處理',
      'capture.ai_extracting':     '正在提取您嘅下一最佳步驟',
      'capture.ai_note':           '由Claude驅動 · 安全 · 不儲存',
      'capture.next_best_step':    '下一最佳步驟',
      'capture.extracted_actions': '提取嘅行動',
      'capture.full_transcript':   '完整記錄',
      'capture.add_to_protocol':   '添加到我嘅方案',
      'capture.dismiss':           '不儲存關閉',
      'capture.saved':             '已儲存到安全室',
      'capture.verified_seal':     '已驗證印章已啟動',
      'capture.view_now_card':     '查看今日方案 →',
      'capture.what_is_for':       '呢個係用嚟做咩？',
      'capture.loop_sync':         'Loop Closer — 藥房同步',
      'capture.terms_in_recap':    '此回顧中嘅術語',
      'capture.instructions_extracted': '條指令已提取',
      'capture.pinging':           '聯絡中…',

      'lex.title':              '精準詞典',
      'lex.search_placeholder': '搜索藥物、程序、術語…',
      'lex.medications':        '藥物',
      'lex.procedures':         '程序',
      'lex.clinical_terms':     '臨床術語',
      'lex.definition':         '定義',
      'lex.side_effects':       '副作用',
      'lex.storage':            '儲存',
      'lex.no_results':         '無結果：',
      'lex.no_results_sub':     '請嘗試搜索藥物名稱、程序或臨床術語。',

      'partner.live_sync':          '實時同步激活',
      'partner.patient_view':       '患者視圖',
      'partner.nav.med_sync':       '藥物同步表格',
      'partner.nav.package':        '套餐狀態',
      'partner.nav.rescue':         '精準救援',
      'partner.nav.qsbs':           'QSBS監控',
      'partner.active_patients':    '活躍患者',
      'partner.critical_alerts':    '緊急警報',
      'partner.verified_today':     '今日已驗證',
      'partner.navigation':         '導航',
      'partner.shift_summary':      '班次摘要',
      'partner.filter.all':         '全部',
      'partner.filter.critical':    '緊急',
      'partner.filter.pending':     '待確認',
      'partner.filter.verified':    '已確認',
      'partner.authorize':          '授權',
      'partner.rescue_btn':         '救援',
      'partner.auth.label':         '授權驗證',
      'partner.auth.meds_to_verify':'待驗證藥物',
      'partner.auth.confirm':       '確認並推送驗證',
      'partner.auth.pushed':        '狀態已通過Supabase實時推送至患者今日方案。',
      'partner.auth.sig_note':      '確認後應用數字簽名',
      'partner.rescue.title':       '精準救援',
      'partner.rescue.sub':         '向患者今日方案發送一鍵臨床覆蓋指令',
      'partner.rescue.select':      '選擇患者',
      'partner.rescue.override':    '覆蓋消息',
      'partner.rescue.templates':   '快速模板',
      'partner.rescue.custom':      '自定義消息',
      'partner.rescue.no_patient':  '未選擇患者 — 請從左側面板選擇。',
      'partner.rescue.send':        '發送精準救援',
      'partner.rescue.note':        '覆蓋指令將立即顯示在患者嘅今日方案中。',
      'partner.qsbs.safe':          '安全',
      'partner.qsbs.warning':       '警告',
      'partner.qsbs.critical':      '危急',
      'partner.qsbs.view_report':   '查看完整報告',
      'partner.grid.title':         '患者藥物同步表格',
      'partner.grid.sub':           '實時藥物驗證狀態 · B班',
      'partner.package.title':      '套餐狀態 — BIFI層',
      'partner.package.sub':        '財務授權狀態 · 臨床執行以批准為前提',
      'partner.last_sync':          '上次同步：',
      'partner.auto_refresh':       '· 每60秒自動刷新',
      'partner.th.patient':         '患者',
      'partner.th.phase':           '階段 · 天數',
      'partner.th.injection':       '下次注射',
      'partner.th.medications':     '藥物',
      'partner.th.pharmacy':        '藥房',
      'partner.th.status':          '狀態',
      'partner.th.actions':         '操作',
    },
  ...
  window.I18N = {
    ...
    apply: function () {
      ...
      // HTML lang
      var langMap = { zh:'zh-Hans', yue:'zh-Hant', es:'es', hi:'hi', en:'en' };
